...
Entry: `openspec` -> `openspec new change <change-name>` (optional shortcut: `/opsx-new <change-name>`), `speckit` -> `specify init --here --ai codex --script sh`.
...
- Entry: `specify init --here --ai codex --script sh`
